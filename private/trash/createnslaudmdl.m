function Stim = createnslaudmdl(FnamesStim, IS_CORTICAL)
...
Filtcoch = struct(Val=CorRep, Info=struct(SpecModCpo=sv, TempModHz=rv, TimeSec=AudTimes, FreqHz=AudFreqs, ...
  DimOrder=["SpecModCpo", "TempModHz", "TimeSec", "FreqHz"]));
