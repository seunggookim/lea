function Job = myspm_fmriprep25 (Job)
% job = myspm_fmriprep25 (job)
%
...
DefaultJob = struct('IsAnts',false, 'Fwhm_mm',[], 'Bpf_hz',[1/128 inf], ...
  'Bbox_mm',[], 'Dummy_sec',[], 'IsFslStc',false, 'IsStc',true, 'FnameJson',[], 'FanmeDcm',[], 'Tr_sec',[], ...
  'Segment','spm25', 'Vox_mm',[1 1 1]*round(abs(diag(V(1).mat(1:3,1:3)))));
