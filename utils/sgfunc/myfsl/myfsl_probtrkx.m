...
% data:
[p1,f1,~] = myfileparts(JOB.dname_bedpostx);
dn_bedpostx = [p1,'/',f1];
ls([dn_bedpostx,'/merged_f1samples.nii.gz']);
dn_probtrkx = [p1,'/',seedname,'-to-',targetname];
prefix_samples = [dn_bedpostx,'/merged'];
fname_mask     = [dn_bedpostx,'/nodif_brain_mask.nii.gz'];
