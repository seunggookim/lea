...
% cmap = get_colormap(nc,nl,[opts])
% nc: Number of Colors
% nl: Number of Levels
% e.g.) RgbMap = get_colormap(3,1);

%% default options (dr.seunggoo.kim@gmail.com:2024-01-10)
if not(exist('opts','var'))
  opts = struct(map='lch', lightness_range=[85 15], chroma_range=[30 90], hue_range=[25 385], ...
    lightness=65, chroma=75, n_color=[], n_lightness=[]);
