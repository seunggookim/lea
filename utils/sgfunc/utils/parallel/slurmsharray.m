function slurmsharray(ShCmd, arrayRange, Cfg)
%slurmsh submit a single-line (piped, semicoloned, whatever) Bash command
%
% [SYNTAX]
% slurmsharray(ShCmd, nJobs, Cfg)
%
% [INPUT]
